...
module.exports = {
  ...
  async execute(interaction) {
    ...
    console.log(magItSearch, 'the result received in command file');

    const magItResults = await MagicItem.getRandomMagicItemsbyId(magItSearch);

    console.log(magItResults, 'final results');

    return interaction.reply({ content: `You find magic item(s): ${magItResults},`, ephemeral: true });
  } };
