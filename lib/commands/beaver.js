...
// A random number is selected between 1 and 100 if the number is 95 or higher it sends the message
//of 'You roll a ${diceResults}. By Tempus's thunder! A mighty beaver!' with a picture. On anything below 95, the user receives a message of
