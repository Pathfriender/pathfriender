...
INSERT INTO magic_items_table(slug,name,type,desc,rarity,requires_attunement,document_slug,document_title) VALUES ('adamantine-armor','Adamantine Armor','Armor (medium or heavy)','This suit of armor is reinforced with adamantine, one of the hardest substances in existence. While you''re wearing it, any critical hit against you becomes a normal hit.','uncommon',NULL,'wotc-srd','Systems Reference Document');
INSERT INTO magic_items_table(slug,name,type,desc,rarity,requires_attunement,document_slug,document_title) VALUES ('amulet-of-health','Amulet of Health','Wondrous item','Your Constitution score is 19 while you wear this amulet. It has no effect on you if your Constitution is already 19 or higher.','rare','requires attunement','wotc-srd','Systems Reference Document');
INSERT INTO magic_items_table(slug,name,type,desc,rarity,requires_attunement,document_slug,document_title) VALUES ('amulet-of-proof-against-detection-and-location','Amulet of Proof against Detection and Location','Wondrous item','While wearing this amulet, you are hidden from divination magic. You can''t be targeted by such magic or perceived through magical scrying sensors.','uncommon','requires attunement','wotc-srd','Systems Reference Document');
INSERT INTO magic_items_table(slug,name,type,desc,rarity,requires_attunement,document_slug,document_title) VALUES ('amulet-of-the-planes','Amulet of the Planes','Wondrous item','While wearing this amulet, you can use an action to name a location that you are familiar with on another plane of existence. Then make a DC 15 Intelligence check. On a successful check, you cast the _plane shift_ spell. On a failure, you and each creature and object within 15 feet of you travel to a random destination. Roll a d100. On a 1-60, you travel to a random location on the plane you named. On a 61-100, you travel to a randomly determined plane of existence.','very rare','requires attunement','wotc-srd','Systems Reference Document');
INSERT INTO magic_items_table(slug,name,type,desc,rarity,requires_attunement,document_slug,document_title) VALUES ('animated-shield','Animated Shield','Armor (shield)','While holding this shield, you can speak its command word as a bonus action to cause it to animate. The shield leaps into the air and hovers in your space to protect you as if you were wielding it, leaving your hands free. The shield remains animated for 1 minute, until you use a bonus action to end this effect, or until you are incapacitated or die, at which point the shield falls to the ground or into your hand if you have one free.','very rare','requires attunement','wotc-srd','Systems Reference Document');
INSERT INTO magic_items_table(slug,name,type,desc,rarity,requires_attunement,document_slug,document_title) VALUES ('apparatus-of-the-crab','Apparatus of the Crab','Wondrous item','This item first appears to be a Large sealed iron barrel weighing 500 pounds. The barrel has a hidden catch, which can be found with a successful DC 20 Intelligence (Investigation) check. Releasing the catch unlocks a hatch at one end of the barrel, allowing two Medium or smaller creatures to crawl inside. Ten levers are set in a row at the far end, each in a neutral position, able to move either up or down. When certain levers are used, the apparatus transforms to resemble a giant lobster.
...
INSERT INTO magic_items_table(slug,name,type,desc,rarity,requires_attunement,document_slug,document_title) VALUES ('armor-of-invulnerability','Armor of Invulnerability','Armor (plate)','You have resistance to nonmagical damage while you wear this armor. Additionally, you can use an action to make yourself immune to nonmagical damage for 10 minutes or until you are no longer wearing the armor. Once this special action is used, it can''t be used again until the next dawn.','legendary','requires attunement','wotc-srd','Systems Reference Document');
INSERT INTO magic_items_table(slug,name,type,desc,rarity,requires_attunement,document_slug,document_title) VALUES ('armor-of-resistance','Armor of Resistance','Armor (light','You have resistance to one type of damage while you wear this armor. The GM chooses the type or determines it randomly from the options below.
...
INSERT INTO magic_items_table(slug,name,type,desc,rarity,requires_attunement,document_slug,document_title) VALUES ('armor-of-vulnerability','Armor of Vulnerability','Armor (plate)','While wearing this armor, you have resistance to one of the following damage types: bludgeoning, piercing, or slashing. The GM chooses the type or determines it randomly.
...
INSERT INTO magic_items_table(slug,name,type,desc,rarity,requires_attunement,document_slug,document_title) VALUES ('bag-of-beans','Bag of Beans','Wondrous item','Inside this heavy cloth bag are 3d4 dry beans. The bag weighs 1/2 pound plus 1/4 pound for each bean it contains.
...
INSERT INTO magic_items_table(slug,name,type,desc,rarity,requires_attunement,document_slug,document_title) VALUES ('bag-of-devouring','Bag of Devouring','Wondrous item','This bag superficially resembles a _bag of holding_ but is a feeding orifice for a gigantic extradimensional creature. Turning the bag inside out closes the orifice.
...
INSERT INTO magic_items_table(slug,name,type,desc,rarity,requires_attunement,document_slug,document_title) VALUES ('bag-of-holding','Bag of Holding','Wondrous item','This bag has an interior space considerably larger than its outside dimensions, roughly 2 feet in diameter at the mouth and 4 feet deep. The bag can hold up to 500 pounds, not exceeding a volume of 64 cubic feet. The bag weighs 15 pounds, regardless of its contents. Retrieving an item from the bag requires an action.
...
INSERT INTO magic_items_table(slug,name,type,desc,rarity,requires_attunement,document_slug,document_title) VALUES ('bag-of-tricks','Bag of Tricks','Wondrous item','This ordinary bag, made from gray, rust, or tan cloth, appears empty. Reaching inside the bag, however, reveals the presence of a small, fuzzy object. The bag weighs 1/2 pound.
...
INSERT INTO magic_items_table(slug,name,type,desc,rarity,requires_attunement,document_slug,document_title) VALUES ('bead-of-force','Bead of Force','Wondrous item','This small black sphere measures 3/4 of an inch in diameter and weighs an ounce. Typically, 1d4 + 4 _beads of force_ are found together.
...
INSERT INTO magic_items_table(slug,name,type,desc,rarity,requires_attunement,document_slug,document_title) VALUES ('belt-of-dwarvenkind','Belt of Dwarvenkind','Wondrous item','While wearing this belt, you gain the following benefits:
...
INSERT INTO magic_items_table(slug,name,type,desc,rarity,requires_attunement,document_slug,document_title) VALUES ('berserker-axe','Berserker Axe','Weapon (any axe)','You gain a +1 bonus to attack and damage rolls made with this magic weapon. In addition, while you are attuned to this weapon, your hit point maximum increases by 1 for each level you have attained.
...
INSERT INTO magic_items_table(slug,name,type,desc,rarity,requires_attunement,document_slug,document_title) VALUES ('boots-of-elvenkind','Boots of Elvenkind','Wondrous item','While you wear these boots, your steps make no sound, regardless of the surface you are moving across. You also have advantage on Dexterity (Stealth) checks that rely on moving silently.','uncommon',NULL,'wotc-srd','Systems Reference Document');
INSERT INTO magic_items_table(slug,name,type,desc,rarity,requires_attunement,document_slug,document_title) VALUES ('boots-of-levitation','Boots of Levitation','Wondrous item','While you wear these boots, you can use an action to cast the _levitate_ spell on yourself at will.','rare','requires attunement','wotc-srd','Systems Reference Document');
INSERT INTO magic_items_table(slug,name,type,desc,rarity,requires_attunement,document_slug,document_title) VALUES ('boots-of-speed','Boots of Speed','Wondrous item','While you wear these boots, you can use a bonus action and click the boots'' heels together. If you do, the boots double your walking speed, and any creature that makes an opportunity attack against you has disadvantage on the attack roll. If you click your heels together again, you end the effect.
...
INSERT INTO magic_items_table(slug,name,type,desc,rarity,requires_attunement,document_slug,document_title) VALUES ('boots-of-striding-and-springing','Boots of Striding and Springing','Wondrous item','While you wear these boots, your walking speed becomes 30 feet, unless your walking speed is higher, and your speed isn''t reduced if you are encumbered or wearing heavy armor. In addition, you can jump three times the normal distance, though you can''t jump farther than your remaining movement would allow.','uncommon','requires attunement','wotc-srd','Systems Reference Document');
INSERT INTO magic_items_table(slug,name,type,desc,rarity,requires_attunement,document_slug,document_title) VALUES ('boots-of-the-winterlands','Boots of the Winterlands','Wondrous item','These furred boots are snug and feel quite warm. While you wear them, you gain the following benefits:
...
INSERT INTO magic_items_table(slug,name,type,desc,rarity,requires_attunement,document_slug,document_title) VALUES ('bowl-of-commanding-water-elementals','Bowl of Commanding Water Elementals','Wondrous item','While this bowl is filled with water, you can use an action to speak the bowl''s command word and summon a water elemental, as if you had cast the _conjure elemental_ spell. The bowl can''t be used this way again until the next dawn.
...
INSERT INTO magic_items_table(slug,name,type,desc,rarity,requires_attunement,document_slug,document_title) VALUES ('brazier-of-commanding-fire-elementals','Brazier of Commanding Fire Elementals','Wondrous item','While a fire burns in this brass brazier, you can use an action to speak the brazier''s command word and summon a fire elemental, as if you had cast the _conjure elemental_ spell. The brazier can''t be used this way again until the next dawn.

The brazier weighs 5 pounds.','rare',NULL,'wotc-srd','Systems Reference Document');
INSERT INTO magic_items_table(slug,name,type,desc,rarity,requires_attunement,document_slug,document_title) VALUES ('brooch-of-shielding','Brooch of Shielding','Wondrous item','While wearing this brooch, you have resistance to force damage, and you have immunity to damage from the _magic missile_ spell.','uncommon','requires attunement','wotc-srd','Systems Reference Document');
INSERT INTO magic_items_table(slug,name,type,desc,rarity,requires_attunement,document_slug,document_title) VALUES ('broom-of-flying','Broom of Flying','Wondrous item','This wooden broom, which weighs 3 pounds, functions like a mundane broom until you stand astride it and speak its command word. It then hovers beneath you and can be ridden in the air. It has a flying speed of 50 feet. It can carry up to 400 pounds, but its flying speed becomes 30 feet while carrying over 200 pounds. The broom stops hovering when you land.
...
INSERT INTO magic_items_table(slug,name,type,desc,rarity,requires_attunement,document_slug,document_title) VALUES ('candle-of-invocation','Candle of Invocation','Wondrous item','This slender taper is dedicated to a deity and shares that deity''s alignment. The candle''s alignment can be detected with the _detect evil and good_ spell. The GM chooses the god and associated alignment or determines the alignment randomly.
...
INSERT INTO magic_items_table(slug,name,type,desc,rarity,requires_attunement,document_slug,document_title) VALUES ('cape-of-the-mountebank','Cape of the Mountebank','Wondrous item','This cape smells faintly of brimstone. While wearing it, you can use it to cast the _dimension door_ spell as an action. This property of the cape can''t be used again until the next dawn.
...
INSERT INTO magic_items_table(slug,name,type,desc,rarity,requires_attunement,document_slug,document_title) VALUES ('carpet-of-flying','Carpet of Flying','Wondrous item','You can speak the carpet''s command word as an action to make the carpet hover and fly. It moves according to your spoken directions, provided that you are within 30 feet of it.
...
INSERT INTO magic_items_table(slug,name,type,desc,rarity,requires_attunement,document_slug,document_title) VALUES ('chime-of-opening','Chime of Opening','Wondrous item','This hollow metal tube measures about 1 foot long and weighs 1 pound. You can strike it as an action, pointing it at an object within 120 feet of you that can be opened, such as a door, lid, or lock. The chime issues a clear tone, and one lock or latch on the object opens unless the sound can''t reach the object. If no locks or latches remain, the object itself opens.
...
INSERT INTO magic_items_table(slug,name,type,desc,rarity,requires_attunement,document_slug,document_title) VALUES ('circlet-of-blasting','Circlet of Blasting','Wondrous item','While wearing this circlet, you can use an action to cast the _scorching ray_ spell with it. When you make the spell''s attacks, you do so with an attack bonus of +5. The circlet can''t be used this way again until the next dawn.','uncommon',NULL,'wotc-srd','Systems Reference Document');
INSERT INTO magic_items_table(slug,name,type,desc,rarity,requires_attunement,document_slug,document_title) VALUES ('cloak-of-arachnida','Cloak of Arachnida','Wondrous item','This fine garment is made of black silk interwoven with faint silvery threads. While wearing it, you gain the following benefits:
...
INSERT INTO magic_items_table(slug,name,type,desc,rarity,requires_attunement,document_slug,document_title) VALUES ('cloak-of-displacement','Cloak of Displacement','Wondrous item','While you wear this cloak, it projects an illusion that makes you appear to be standing in a place near your actual location, causing any creature to have disadvantage on attack rolls against you. If you take damage, the property ceases to function until the start of your next turn. This property is suppressed while you are incapacitated, restrained, or otherwise unable to move.','rare','requires attunement','wotc-srd','Systems Reference Document');
INSERT INTO magic_items_table(slug,name,type,desc,rarity,requires_attunement,document_slug,document_title) VALUES ('cloak-of-elvenkind','Cloak of Elvenkind','Wondrous item','While you wear this cloak with its hood up, Wisdom (Perception) checks made to see you have disadvantage, and you have advantage on Dexterity (Stealth) checks made to hide, as the cloak''s color shifts to camouflage you. Pulling the hood up or down requires an action.','uncommon','requires attunement','wotc-srd','Systems Reference Document');
INSERT INTO magic_items_table(slug,name,type,desc,rarity,requires_attunement,document_slug,document_title) VALUES ('cloak-of-protection','Cloak of Protection','Wondrous item','You gain a +1 bonus to AC and saving throws while you wear this cloak.','uncommon','requires attunement','wotc-srd','Systems Reference Document');
INSERT INTO magic_items_table(slug,name,type,desc,rarity,requires_attunement,document_slug,document_title) VALUES ('cloak-of-the-bat','Cloak of the Bat','Wondrous item','While wearing this cloak, you have advantage on Dexterity (Stealth) checks. In an area of dim light or darkness, you can grip the edges of the cloak with both hands and use it to fly at a speed of 40 feet. If you ever fail to grip the cloak''s edges while flying in this way, or if you are no longer in dim light or darkness, you lose this flying speed.
...
INSERT INTO magic_items_table(slug,name,type,desc,rarity,requires_attunement,document_slug,document_title) VALUES ('cloak-of-the-manta-ray','Cloak of the Manta Ray','Wondrous item','While wearing this cloak with its hood up, you can breathe underwater, and you have a swimming speed of 60 feet. Pulling the hood up or down requires an action.','uncommon',NULL,'wotc-srd','Systems Reference Document');
INSERT INTO magic_items_table(slug,name,type,desc,rarity,requires_attunement,document_slug,document_title) VALUES ('crystal-ball','Crystal Ball','Wondrous item','The typical _crystal ball_, a very rare item, is about 6 inches in diameter. While touching it, you can cast the _scrying_ spell (save DC 17) with it.
...
INSERT INTO magic_items_table(slug,name,type,desc,rarity,requires_attunement,document_slug,document_title) VALUES ('cube-of-force','Cube of Force','Wondrous item','This cube is about an inch across. Each face has a distinct marking on it that can be pressed. The cube starts with 36 charges, and it regains 1d20 expended charges daily at dawn.
...
INSERT INTO magic_items_table(slug,name,type,desc,rarity,requires_attunement,document_slug,document_title) VALUES ('dagger-of-venom','Dagger of Venom','Weapon (dagger)','You gain a +1 bonus to attack and damage rolls made with this magic weapon.
...
INSERT INTO magic_items_table(slug,name,type,desc,rarity,requires_attunement,document_slug,document_title) VALUES ('dancing-sword','Dancing Sword','Weapon (any sword)','You can use a bonus action to toss this magic sword into the air and speak the command word. When you do so, the sword begins to hover, flies up to 30 feet, and attacks one creature of your choice within 5 feet of it. The sword uses your attack roll and ability score modifier to damage rolls.
...
INSERT INTO magic_items_table(slug,name,type,desc,rarity,requires_attunement,document_slug,document_title) VALUES ('decanter-of-endless-water','Decanter of Endless Water','Wondrous item','This stoppered flask sloshes when shaken, as if it contains water. The decanter weighs 2 pounds.
...
INSERT INTO magic_items_table(slug,name,type,desc,rarity,requires_attunement,document_slug,document_title) VALUES ('deck-of-illusions','Deck of Illusions','Wondrous item','This box contains a set of parchment cards. A full deck has 34 cards. A deck found as treasure is usually missing 1d20 - 1 cards.
...
INSERT INTO magic_items_table(slug,name,type,desc,rarity,requires_attunement,document_slug,document_title) VALUES ('deck-of-many-things','Deck of Many Things','Wondrous item','Usually found in a box or pouch, this deck contains a number of cards made of ivory or vellum. Most (75 percent) of these decks have only thirteen cards, but the rest have twenty-two.
