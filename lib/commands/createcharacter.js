      ...
      .addComponents(
        new MessageSelectMenu()
          ...
          .addOptions([
            {
              label: 'Fighter',
              description: 'Hit them with your sword. Uses Strength and Constitution, and a little Dexterity.',
              value: 'Fighter',
            },
            {
              label: 'Rogue',
              description: 'Stab them in the back and slink away in shadow. Uses Dexterity mostly but Charisma if you get caught.',
              value: 'Rogue',
            },
            {
              label: 'Wizard',
            ...
            {
              label: 'Warlock',
              description: 'Call upon an otherworldly being of immense power to spam Eldritch Blast. Uses Charisma and Constitution..',
              value: 'Warlock'
            },
            {
              label: 'Sorceror',
            ...
            {
              label: 'Paladin',
              description: 'Spread the will of your deity through preaching and sometimes a glowing sword. Uses Charisma, Strength, Dexterity, and Constitution.',
              value: 'Paladin'
            },
            {
              label: 'Druid',
            ...
            {
              label: 'Ranger',
              description: 'Explore the unexplored, see the unseen. Have your pet bear eat the unseen. Uses Dexterity and Wisdom.',
              value: 'Ranger'
            },
            {
              label: 'Cleric',
              description: 'Act as an instrument of your deity and embody its will on your plane. Uses Wisdom, Strength, and Dexterity.',
              value: 'Cleric'
            },
            {
              label: 'Monk',
              description: 'See the ki that flows through all things and enhance yourself with it. Uses Wisdom, Dexterity, and Constitution.',
              value: 'Monk'
            },
            {
              label: 'Artificer',
      ...
      .addComponents(
        new MessageSelectMenu()
          ...
          .addOptions([
            ...
            {
              label: 'Genasi',
              description: 'The elemental planes run through their veins. +2 constitution, and other changes per element.',
              value: 'Genasi'
            },
            {
              label: 'Aasimar',
