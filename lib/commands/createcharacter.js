...
module.exports = {
  ...
  async execute(interaction) {
    const existingCharacter = await Character.getCharNameByUserId(interaction.user_id);
    if (existingCharacter !== null) {
        ...
        .addComponents(
          new MessageSelectMenu()
            ...
            .addOptions([
              ...
              {
                label: 'Earth Genasi',
                description: 'As stubborn and unmoving as elemental earth. +2 con, +1 sdtrength. Walk through earth.',
                value: 'Earth Genasi'
              },
      ...
      classMessage.awaitMessageComponent({ filter, componentType: 'SELECT_MENU', time: 60000 })
        ...
        .catch(err => classMessage.delete()); //deleteStuff
